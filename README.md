...
This repo is just a compilation of random .c programs I wrote as I trudged my way through K&R's ANSI edition. The organization matches that of the book. Some scripts are annotated exemplars/exercises from the book, some are extra programs I wrote for fun.

There's a separate projects folder for longer programs; these try to use C in a more practical setting. In general these don't fall into any of the discrete sections, and therefore are in a separate `/projects` folder instead.
